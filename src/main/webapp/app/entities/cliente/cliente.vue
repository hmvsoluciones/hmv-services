      ...
      <table class="table table-striped" aria-describedby="clientes">
        <thead>
          <tr>
            ...
            <th scope="row" @click="changeOrder('identificacion')">
              <span>Identificacion</span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'identificacion'"></jhi-sort-indicator>
            </th>
            <th scope="row" @click="changeOrder('direccion')">
              <span>Direccion</span>
